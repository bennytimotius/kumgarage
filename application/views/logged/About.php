...
<body>
   ...
   <div class="wrap">
	    ...
	    <div class="content">
	    	 <h2>About Us</h2>
	    	<div class="image group about_desc">
					<div class="grid images_3_of_2">
						<img src="<?php echo base_url("assets/images/about-img.png") ?>" alt="" />
					</div>
				<div class="desc span_3_of_2">
					<p><span>Bengkel KUM berdiri pada Juni 2006</span></p>
					<p>Kami sudah berpengalaman lama dalam dunia otomotif, selain itu kami tidak hanya menangani kendaraan secara konvensional, kami mampu memperbaiki mesin seperti Genset, Mobil Listrik, dll.</p>
					<p>Kami sebisa mungkin tidak pernah menolak orderan perbaikan karena alasan teknis, biasanya dikarenakan stok spare parts yang tidak ada atau jadwal yang penuh.</p>
				</div>
				 
		      </div>	
				<div class="team">
					<h2>Management Team</h2>
					<p>Team KUM terdiri dari 2 orang, 1 Owner dan 1 Pegawai</p>
				    <div class="section group">
				<div class="grid_1_of_3 images_1_of_2">
					  <img src="<?php echo base_url("assets/images/management-1.png") ?>" alt="" />
					  <h3 style="color:#E5B840;
								margin-top:0.4em;
								margin-bottom:0.2em;
								font-size:1.5em;
								font-family: 'bebas_neueregular';
								text-align:center;">Freddy Karyo Utomo</h3>
					
				</div>
				<div class="grid_1_of_3 images_1_of_2">
					  <img src="<?php echo base_url("assets/images/management-2.png") ?>" alt="" />
					  <h3 style="color:#E5B840;
								margin-top:0.4em;
								margin-bottom:0.2em;
								font-size:1.5em;
								font-family: 'bebas_neueregular';
								text-align:center;">Ryan</h3>
