		 ...
		 <div class="header_image">
		   <img src="<?php echo base_url("assets/images/header.jpg") ?>" alt="" />
              ...
              <div class="header-bottom">
		          <div class="menu">
					    <ul>
							<li><a href="<?php echo base_url().'admin' ?>">Booking</a></li>
				  ...
				  <?php echo form_open_multipart('admin/updateProfile/' . $username); ?>
					    <form method="post" >
					    	<div>
						    	...
						    	<span><input name="username" type="text" class="textbox" placeholder="Insert New Username"></span>
						    </div>
					    	<div>
						    	<span><label>Nama</label></span>
						    	<span><input name="name" type="text" class="textbox" value="<?php echo $name; ?>"></span>
						    </div>
						   <div>
						    	<span><label>Password</label></span>
						    	<span><input name="password" type="text" class="textbox" placeholder="Insert New Password"></span>
						    </div>
						    <div>
						    	<span><label>Email</label></span>
						    	<span><input name="email" type="text" class="textbox" value="<?php echo $email; ?>"></span>
						    </div>
						    <div>
						    	<span><label>Nomor</label></span>
						    	<span><input name="nomor" type="number" class="textbox" value="<?php echo $nomor; ?>"></span>
						    </div>
						   <div>
						   		<span><input type="submit" value="Update"></span>
						  </div>
