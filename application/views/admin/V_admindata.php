...
<body>
   ...
   <div class="wrap">
		...
		<div class="table-responsive">
			...
			$x['id']?>"></td>
			<td><a href="<?php echo site_url("admin/viewProfile/".$x['username']); ?>" class="button">Update</a>
			   <td>Click Update to change</td>
			   <td>Click Update to change</td>
			   <td><?= $x['name'] ?></td> 
			   <td><?= $x['email'] ?></td>
			   <td><?= $x['nomor'] ?></td>
			   <td>
                <img src="<?php echo base_url().$x['pic']; ?>" width="120" height="150">
	            </td>
			  </tr>
			  <?php } ?>
			 </tbody>
