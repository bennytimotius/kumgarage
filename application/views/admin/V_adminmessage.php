...
<body>
   ...
   <div class="wrap">
   	 <div class="main">
	    <div class="content">
	    	<h2>Message Booking</h2>
	    	 <div class="section group">
				<div class="col span_2_of_3">
				  <div class="contact-form">
					    <form method="post" action="<?php echo base_url().'admin/messageBooking' ?>">
						    <div>
						    	<span>Photo</span>
						    ...
						    <div>
						    	...
						    	<span><textarea name="message" class="materialize-textarea" data-length="120"> </textarea></span>
						    </div>
						   <div>
