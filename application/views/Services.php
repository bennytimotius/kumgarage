...
<html>
<head>
<title>KUM Garage | Services</title>
              ...
              <div class="header-bottom">
		          <div class="menu">
					    <ul>
							...
							<li><a href="<?php echo base_url().'about_c' ?>">About</a></li>
							<li class="active"><a href="<?php echo base_url().'services_c' ?>">Services</a></li>
					...
					<div class="num-heading">
					  ...
					  <div class="col_1_of_4 span_1_of_4">
						 <div class="num-heading">
						   ...
						   <div class="heading">								
							  <h4>Electrical / Wiring Services</h4>
						   </div>
						    <div class="clear"></div>
							</div> 
